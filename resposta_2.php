...
<body>
    <div class="container">
        ...
        <table class="table table-bordered">
            ...
            <tbody>
                <?php include './fetchs/fetch_data2.php'; ?>
            </tbody>
        </table>
        <button onclick="printPage()" class="btn btn-secondary print-only">
            <img src="./assets/print-icon.png" alt="Imagem de Imprimir" class="imprimirImg">
        </button>
    </div>
    <script>
        function printPage() {
